...
PBoardBean bb=bdao.getBoard(num);
...
onclick="location.href='pupdateForm.jsp?num=<%=bb.getNum()%>'">
<input type="button" value="글삭제" class="btn" 
onclick="location.href='pdeleteForm.jsp?num=<%=bb.getNum()%>'">		
		<%
	}
}
%>
<input type="button" value="글목록" class="btn" onclick="location.href='pnotice.jsp'">
</div>
<div class="clear"></div>
<div id="page_control">
</div>
