...
for(int i = 0; i<boardList.size(); i++){
	...
	if(bb.getRe_lev()>0){
		wid=bb.getRe_lev()*10;
	%>
	<img src="../images/center/level.gif" width="<%=wid%>" height="20"/>
...
if(id!=null){
	%>
<div id="table_search">
<input type="submit" name="글쓰기" value="글쓰기" class="btn" onclick="location.href='writeForm.jsp'">
</div>
	<%
